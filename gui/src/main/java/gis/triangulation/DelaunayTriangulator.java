...
/**
 * A Java implementation of an incremental 2D Delaunay gis.triangulation algorithm.
 *
...
public class DelaunayTriangulator {
    ...
    /**
     * This method generates a Delaunay gis.triangulation from the specified point
     * set.
     *
    ...
    public void triangulate() throws NotEnoughPointsException {
         ...
         * to be very large. Otherwise the gis.triangulation is not convex.
         */
